    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="container">
                    <form action=" {{route('libroLive.store')}} " method="post">
                        @csrf
                        <table class="table-fixed">
                        <tbody>
                          <tr>
                            <td class="border px-4 py-2">Autor</td>
                            <td class="border px-4 py-2"><input type="text" name="autor" id="autor">
                                @error('autor') {{$message}} @enderror
                        </td>
                          </tr>
                          <tr>
                            <td class="border px-4 py-2">Titulo</td>
                            <td class="border px-4 py-2"><input type="text" name="titulo" id="titulo">
                                @error('titulo') {{$message}} @enderror
                            </td>
                          </tr>
                          <tr>
                            <td class="border px-4 py-2">Edición</td>
                            <td class="border px-4 py-2"><input type="text" name="edicion" id="edicion">
                                @error('edicion') {{$message}} @enderror
                            </td>
                          </tr>
                          <tr>
                            <td class="border px-4 py-2">Datos de Publicación</td>
                            <td class="border px-4 py-2"><input type="text" name="datosDePublicacion" id="datosDePublicacion">
                                @error('datosDePublicacion') {{$message}} @enderror
                            </td>
                          </tr>
                          <tr>
                            <td class="border px-4 py-2">Tipo de Contenido</td>
                            <td class="border px-4 py-2"><input type="text" name="tipoDeContenido" id="tipoDeContenido">
                                @error('tipoDeContenido') {{$message}} @enderror
                            </td>
                          </tr>
                          <tr>
                            <td class="border px-4 py-2">Restricciones</td>
                            <td class="border px-4 py-2"><input type="text" name="restricciones" id="restricciones">
                                @error('restricciones') {{$message}} @enderror
                            </td>
                          </tr>
                          <tr>
                            <td class="border px-4 py-2">Materia</td>
                            <td class="border px-4 py-2"><input type="text" name="materia" id="materia">
                                @error('materia') {{$message}} @enderror
                            </td>
                          </tr>
                          <tr>
                            <td class="border px-4 py-2">Proveedor</td>
                            <td class="border px-4 py-2"><input type="text" name="proveedor" id="proveedor">
                          ...
                          <input type="hidden" value="vacio" name="imagen2" id="imagen2">
                        </tbody>
                      </table>
                        <br>
                      <button class='
